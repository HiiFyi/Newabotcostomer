...
async def start(client:Client, message):
    ...
    delCap = "<b>⚠️ ʏᴏᴜʀ ғɪʟᴇ ᴡɪʟʟ ʙᴇ ᴀᴜᴛᴏ-ᴅᴇʟᴇᴛᴇᴅ ᴀғᴛᴇʀ {} ⏳ ᴛᴏ ᴀᴠᴏɪᴅ ᴄᴏᴘʏʀɪɢʜᴛ ɪꜱꜱᴜᴇꜱ ❌\n\n🔁 ғᴏʀᴡᴀʀᴅ ᴛʜᴇ ғɪʟᴇꜱ ᴛᴏ ʏᴏᴜʀ ғʀɪᴇɴᴅꜱ ᴀɴᴅ\nɢʀᴏᴜᴘꜱ ✅</b>".format(f'{FILE_AUTO_DEL_TIMER / 60} ᴍɪɴᴜᴛᴇs' if FILE_AUTO_DEL_TIMER >= 60 else f'{FILE_AUTO_DEL_TIMER} sᴇᴄᴏɴᴅs')
