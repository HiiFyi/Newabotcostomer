import os
class script(object):
    START_TXT = """<b>ʜᴇʏ {}, {}\n\n🍿 𝗪𝗲𝗹𝗰𝗼𝗺𝗲 𝘁𝗼 𝗭𝗮𝗿𝗮𝗳𝗹𝗶𝘅 — 𝘆𝗼𝘂𝗿 𝗽𝗲𝗿𝘀𝗼𝗻𝗮𝗹\n𝗺𝗼𝘃𝗶𝗲 & 𝘄𝗲𝗯 𝘀𝗲𝗿𝗶𝗲𝘀 𝗵𝗲𝗹𝗽𝗲𝗿.\n\n🎬 𝗝𝘂𝘀𝘁 𝘁𝘆𝗽𝗲 𝘁𝗵𝗲 𝗻𝗮𝗺𝗲 𝗼𝗳 𝘁𝗵𝗲 𝗺𝗼𝘃𝗶𝗲 𝗼𝗿\n𝘄𝗲𝗯 𝘀𝗲𝗿𝗶𝗲𝘀 𝘄𝗶𝘁𝗵 𝗰𝗼𝗿𝗿𝗲𝗰𝘁 𝘀𝗽𝗲𝗹𝗹𝗶𝗻𝗴, 𝗮𝗻𝗱 𝗜’𝗹𝗹\n𝗳𝗶𝗻𝗱 𝗶𝘁 𝗳𝗼𝗿 𝘆𝗼𝘂 𝗶𝗻𝘀𝘁𝗮𝗻𝘁𝗹𝘆! ⚡"""
...
<blockquote>🌿 ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href='http://t.me/ZaraflixAdmin_Bot'>Zaraflix</a></b></blockquote>"""
...
🏆 ɪꜰ ʏᴏᴜ ᴡᴀɴᴛ ᴀ ɴᴇᴡ ᴘʟᴀɴ ᴀᴘᴀʀᴛ ꜰʀᴏᴍ ᴛʜᴇ ɢɪᴠᴇɴ ᴘʟᴀɴ, ᴛʜᴇɴ ʏᴏᴜ ᴄᴀɴ ᴛᴀʟᴋ ᴛᴏ ᴏᴜʀ <a href='https://t.me/ZaraflixAdmin_Bot'>ᴏᴡɴᴇʀ</a> ᴅɪʀᴇᴄᴛʟʏ ʙʏ ᴄʟɪᴄᴋɪɴɢ ᴏɴ ᴛʜᴇ ᴄᴏɴᴛᴀᴄᴛ ʙᴜᴛᴛᴏɴ ɢɪᴠᴇɴ ʙᴇʟᴏᴡ.
...
🆔 Admin Id ➩ @ZaraflixAdmin_Bot 
 
⛽️ ᴄʜᴇᴄᴋ ʏᴏᴜʀ ᴀᴄᴛɪᴠᴇ ᴘʟᴀɴ: /myplan

🏷️ <a href='https://t.me/ZaraflixAdmin_Bot'>ᴘʀᴇᴍɪᴜᴍ ᴘʀᴏᴏꜰ</a>
